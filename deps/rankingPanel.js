async function fetchData() {
    ...
    if  (tempUsername !== "")
        playerData = await getUserData(tempUsername);
...
function setupRankingPanel() {
    ...
    scoreResult.innerHTML = Number(tempScore).toLocaleString();
    ...
    recorderInfo.style.transform = "none";
}
...
function deRankingPanel() {
    ...
    recorderInfo.style.transform = "translateY(100px)";
